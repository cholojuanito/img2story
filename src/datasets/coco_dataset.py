...
class CoCoDataset(Dataset):
    ...
    '''
    def __init__(self, coco_root, train_or_test, img_transform, batch_size, vocab, year='2014') -> None:
    ...
    def get_train_indices(self):
        '''
        Randomly samples a batch_size worth of captions *all of length length*
        '''
        assert self.mode == 'train', "Must be in training mode to use this function"
